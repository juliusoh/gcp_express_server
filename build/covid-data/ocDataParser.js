...
function ocCurrentParser() {
    return __awaiter(this, void 0, void 0, function* () {
        //  table should be created once
        const records = yield (0, getCovidData_1.getOCData)();
        try {
            const data = lodash_1.default.pick(records.data, [
                "fips",
                "country",
                "state",
                "county",
            ...
            const existingState = yield db_1.CurrentOrange.findOne({ where: { fips: data.fips } });
            if (existingState) {
                yield existingState.update(data);
            }
            else {
                yield db_1.CurrentOrange.create(data);
            }
...
ocCurrentParser();
exports.default = ocCurrentParser;
