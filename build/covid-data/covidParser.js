...
function currentStatesParser() {
    return __awaiter(this, void 0, void 0, function* () {
        //  table should be created once
        const records = yield (0, getCovidData_1.getCurrentStatesData)();
        yield Promise.all(records.map((record) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingState = yield db_1.CurrentState.findOne({ where: { fips: data.fips } });
                if (existingState) {
                    yield existingState.update(data);
                }
                else {
                    yield db_1.CurrentState.create(data);
                }
...
exports.default = currentStatesParser;
