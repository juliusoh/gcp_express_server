...
function covidTrendsParser() {
    return __awaiter(this, void 0, void 0, function* () {
        const records = JSON.parse(yield (0, googleTrends_1.covidTrendsOverTime)());
        records.default.timelineData.forEach((record) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // } else {
                yield db_1.CovidTrend.destroy({ where: {} });
                yield db_1.CovidTrend.create({
                    time: newTime,
                    popularityValue: value[0],
                });
                // }
                logger_1.default.info(`covid trends added at ${utc}`);
            }
            catch (error) {
                console.error(error);
            }
...
exports.default = covidTrendsParser;
