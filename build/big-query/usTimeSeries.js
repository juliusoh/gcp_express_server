...
exports.getUSTimeSeries = void 0;
...
function createTempCSVFileWithContent(content) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tempFile = path_1.default.join(tempFolder, "usTimeSeries" + Date.now() + ".csv");
...
function getUSTimeSeries() {
    return __awaiter(this, void 0, void 0, function* () {
        const bigQuery = new bigquery_1.BigQuery(bigQueryCreds);
        let fileName;
        try {
            const response = yield axios_1.default.get(`https://api.covidactnow.org/v2/country/US.timeseries.csv?apiKey=${process.env.API_KEY}`);
...
exports.getUSTimeSeries = getUSTimeSeries;
