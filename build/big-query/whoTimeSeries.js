...
exports.whoGlobalTimeSeries = void 0;
...
function createTempCSVFileWithContent(content) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tempFile = path_1.default.join(tempFolder, "GlobalTimeSeries" + Date.now() + ".csv");
...
function whoGlobalTimeSeries() {
    return __awaiter(this, void 0, void 0, function* () {
        const bigQuery = new bigquery_1.BigQuery(bigQueryCreds);
        let fileName;
        try {
            const response = yield axios_1.default.get(`https://covid19.who.int/WHO-COVID-19-global-data.csv`);
...
exports.whoGlobalTimeSeries = whoGlobalTimeSeries;
