...
function createTempCSVFileWithContent(content) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tempFile = path_1.default.join(tempFolder, "whoCurrentData" + Date.now() + ".csv");
...
function whoCurrentData() {
    return __awaiter(this, void 0, void 0, function* () {
        const bigQuery = new bigquery_1.BigQuery(bigQueryCreds);
        let fileName;
        try {
            const response = yield axios_1.default.get(`https://covid19.who.int/WHO-COVID-19-global-table-data.csv`);
            ...
            const tableId = "whoCurrentGlobalData";
...
exports.whoCurrentData = whoCurrentData;
