...
exports.getOwidTimeSeries = void 0;
...
function createTempCSVFileWithContent(content) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tempFile = path_1.default.join(tempFolder, "owidData" + Date.now() + ".csv");
...
function getOwidTimeSeries() {
    return __awaiter(this, void 0, void 0, function* () {
        const bigQuery = new bigquery_1.BigQuery(bigQueryCreds);
        let fileName;
        try {
            const response = yield axios_1.default.get(`https://covid.ourworldindata.org/data/owid-covid-data.csv`);
            ...
            const tableId = "owidGlobalTimeSeries";
...
exports.getOwidTimeSeries = getOwidTimeSeries;
